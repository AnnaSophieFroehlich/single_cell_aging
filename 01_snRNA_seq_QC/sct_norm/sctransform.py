# INFO: code is from https://github.com/gokceneraslan/sctoolkit

# Important note: rpy2 version needs to be <=3.4.2 --> install this version with pip
# Otherwise conversion will break
...
def sctransform(
    ...
    ro.r('options(future.globals.maxSize = 5 * 1000 ^ 3)')
